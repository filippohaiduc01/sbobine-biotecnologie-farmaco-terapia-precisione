...
| `"[concetti chiave per i vari corsi]"` | variabile `PROMPT` | Termini tecnici, nomi propri, acronimi ricorrenti nella lezione (es. nomi di farmaci, geni, professori) — aiuta la trascrizione a riconoscerli correttamente invece di "inventare" parole simili. |
